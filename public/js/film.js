(function () {
    ...
    var Film = function () {
        ...
        this.dom = {
            ...
            page: $('#page'), //分页的url
            filmName: $('#filmName'), //名字的输入框
            filmImg: $('#filmImg'), //url的输入框
            describe: $('#describe'),
            star: $('#star'),
            addModal: $('#myModal'), //模态框
            addFilm: $('#addFilm'), //确认添加按钮
    ...
    Film.prototype.add = function () {
        ...
        //2.给formData对象加属性
        formData.append('filmrName', this.dom.filmName.val());
        formData.append('filmImg', this.dom.filmImg[0].files[0]);
        $.ajax({
            url: '/film/add',
            method: 'POST',
            contentType: false,
            ...
            complete: function () {
                ...
                //手动清空输入框的内容
                _this.dom.filmName.val('');
                _this.dom.filmImg.val('');
            }
        })
    }
    //查询方法
    ...
    //将所有dom操作放在这里
    Film.prototype.bindDom = function () {
        var _this = this;
        //点击确定添加按钮调用add
        this.dom.addFilm.click(function () {
            _this.add();
        })
        //分页按钮点击事件
